...
@interface ManageKeyViewController : UIViewController <UITextFieldDelegate> {

	IBOutlet UITextField* key;
	IBOutlet UITextField* confirmKey;
...
@property (nonatomic, retain) IBOutlet UITextField* confirmKey;
